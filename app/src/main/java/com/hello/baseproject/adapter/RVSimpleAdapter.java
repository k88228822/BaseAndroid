...
import com.hello.baseproject.base.RVBaseAdapter;
import com.hello.baseproject.cell.EmptyCell;
import com.hello.baseproject.cell.ErrorCell;
import com.hello.baseproject.cell.LoadMoreCell;
import com.hello.baseproject.cell.LoadingCell;
import com.hello.baseproject.utils.ConstantUtil;
import com.hello.baseproject.utils.DisplayUtil;

import static com.hello.baseproject.utils.ConstantUtil.BANNER_TYPE;
import static com.hello.baseproject.utils.ConstantUtil.EMPTY_TYPE;
import static com.hello.baseproject.utils.ConstantUtil.LOADING_TYPE;
import static com.hello.baseproject.utils.ConstantUtil.LOAD_MORE_TYPE;
...
public class RVSimpleAdapter extends RVBaseAdapter {
        ...
        if(manager instanceof GridLayoutManager){
            ...
            gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    ...
                    return (viewType == ConstantUtil.ERROR_TYPE|| viewType == EMPTY_TYPE || viewType == LOADING_TYPE
                    ||viewType == LOAD_MORE_TYPE
                            ||(viewType>=ConstantUtil.TITLE_MIN&&viewType<=ConstantUtil.TITLE_MAX)
                            ||viewType==BANNER_TYPE) ? gridLayoutManager.getSpanCount():1;
                }
            });
        }
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        if(isStaggeredGridLayout(holder)){
            if(viewType == ConstantUtil.ERROR_TYPE|| viewType == EMPTY_TYPE || viewType == LOADING_TYPE
                    ||viewType == LOAD_MORE_TYPE
                    ||(viewType>=ConstantUtil.TITLE_MIN&&viewType<=ConstantUtil.TITLE_MAX)
                    ||viewType==BANNER_TYPE){
    ...
    public void showLoadMore(View loadMoreView,int height){
       ...
       //设置默认高度
       if(height == 0){
           int defaultHeight = DisplayUtil.dp2px(loadMoreView.getContext(),LoadMoreCell.mDefaultHeight);
